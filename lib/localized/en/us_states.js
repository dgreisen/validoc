...
(function() {
  ...
  us_states.US_TERRITORIES = [['AS', 'American Samoa'], ['GU', 'Guam'], ['MP', 'Northern Mariana Islands'], ['PR', 'Puerto Rico'], ['VI', 'Virgin Islands']];

  us_states.ARMED_FORCES_STATES = [['AA', 'Armed Forces Americas'], ['AE', 'Armed Forces Europe'], ['AP', 'Armed Forces Pacific']];

  us_states.COFA_STATES = [['FM', 'Federated States of Micronesia'], ['MH', 'Marshall Islands'], ['PW', 'Palau']];

  us_states.OBSOLETE_STATES = [['CM', 'Commonwealth of the Northern Mariana Islands'], ['CZ', 'Panama Canal Zone'], ['PI', 'Philippine Islands'], ['TT', 'Trust Territory of the Pacific Islands']];
