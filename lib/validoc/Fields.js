...
(function() {
  ...
  Field = (function() {
    ...
    Field.prototype.getWidget = function() {
      ...
      var widget;
      widget = this.widget || this.defaultWidget;
      if (_.isFunction(widget.render) || _.isString(widget)) {
        widget = {
          widget: widget
        };
      }
      if (widget.label == null) {
        widget.label = this.name;
      }
      return widget;
    };

    Field.prototype.updateValue = function(path, value) {

      /* return a new field with value at path set to value */
      var currentValue, opts, schema;
      schema = _.clone(this._rawSchema);
      currentValue = this.getValue();
      opts = _.clone(this._rawOpts);
      opts.initialValue = this.getInitialValue();
      opts.value = utils.updateObjectAtPath(currentValue, path, value);
      return fields.genField(schema, opts, parent);
    };
